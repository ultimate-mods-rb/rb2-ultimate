...
del "%~dp0\iso\RB2 Ultimate.wbfs"
"%~dp0dependencies/wit/wit" copy "%~dp0\_build\wii" "%~dp0\iso\RB2 Ultimate.wbfs"

RB2 ultimate should've successfully built. copy the wbfs to your console to play. enjoy :)
